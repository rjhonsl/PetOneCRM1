...
public class Adapter_UnsynchedClientUpdates extends ArrayAdapter<CustInfoObject> {
	...
	public Adapter_UnsynchedClientUpdates(Context context, int resourceId, List<CustInfoObject> items) {
