...
public class SimpleFileDialog 
{
	...
	private String m_sdcardDirectory = "/.pnt/local/";
	private Context m_context;
	private TextView m_titleView1;
	private TextView m_titleView;
	public String Default_File_Name = "default.db";
	private String Selected_File_Name = Default_File_Name;
	private EditText input_text;
	
	private String m_dir = Environment.getExternalStorageDirectory()+"/.pnt/local/";
			...
			DialogInterface.OnClickListener onClickListener)
	{
		...
		m_titleView1.setBackgroundColor(m_context.getResources().getColor(R.color.gray_100)); // dark gray 	-12303292
		...
		m_titleView.setBackgroundColor(m_context.getResources().getColor(R.color.gray_100)); // dark gray -12303292
